...
func main() {
	...
	server.Use(cors.New(cors.Config{
		AllowOrigins:     []string{"https://space-book-pied.vercel.app/", "https://crack-dingo-relative.ngrok-free.app/", "http://client", "https://client", "https://crack-dingo-relative.ngrok-free.app/"},
