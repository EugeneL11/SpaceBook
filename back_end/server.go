...
func main() {
	...
	server.Use(cors.New(cors.Config{
		AllowOrigins:     []string{"http://localhost:3000", "http://localhost:8080", "http://client", "https://client", "https://localhost:8080", "https://space-book-pied.vercel.app", "https://space-book-pied.vercel.app/", "https://crack-dingo-relative.ngrok-free.app", "https://crack-dingo-relative.ngrok-free.app/", "*"},
