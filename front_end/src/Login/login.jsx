...
function Login(props) {
    ...
    <div className="flex flex-col items-center">
        ...
        <div className="bg-white text-black text-center text-xl p-10 sm:p-14 rounded-md w-2/3 sm:w-1/2 lg:w-2/5 xl:w-1/3 min-w-fit">
            ...
            <button className="bg-purple-200 px-7 py-3 mt-10 rounded-lg" onClick={loginAction}>Log In</button>
        </div>

        <button className="text-xl mt-12" onClick={toggleRegister}>Sign Up</button>
    </div>
    );
